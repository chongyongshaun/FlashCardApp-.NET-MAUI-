...
public partial class EditPage : ContentPage
{
    ...
    public QuizPage QuizPageInstance { get; set; }
	public EditPage(Card card, QuizPage quizPage) //get card data to use for the entry and also an instance of the quizpage obj to get the savecards method
	{
		InitializeComponent();
		Card = card;
        QuizPageInstance = quizPage;
    ...
    private async void SaveButton_Clicked(object sender, EventArgs e)
    {
        ...
        QuizPageInstance.SaveCardsToPreferences();
    }
}